				...
				<section id="about" className="mx-auto grid max-w-7xl items-center gap-12 px-8 py-20 md:grid-cols-2">
					<div>
						...
						<p className="mb-4 text-sm leading-relaxed text-slate-600">
							A flagship Government of India scheme, undertaken by the Ministry of Human Resource Development, connecting fresh graduates with top industries for hands-on practical training.
						</p>
						<p className="mb-6 text-sm leading-relaxed text-slate-600">
							Started by the Board of Apprenticeship and Training, the programme aims to enhance employability by equipping technically qualified youth with practical knowledge and skills required in their respective fields of work.
						</p>
						<ul className="mb-8 space-y-3">
							{[
								'1 to 3 years skilled training',
								'Monthly stipend (min. 8,000)',
								'Certificate of Proficiency by Govt. of India',
								'Real industry work experience',
								'Valid employment experience at exchanges',
								'Governed solely by Apprentices Act, 1961'
							].map((item) => (
					...
					<div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-3">
						{processSteps.map((step) => (
							<div key={step.id} className="group relative overflow-hidden rounded-2xl border border-slate-100 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-2xl">
								...
								<p className="relative z-10 text-sm text-slate-500"></p>
							</div>
						))}
					</div>
				</section>
